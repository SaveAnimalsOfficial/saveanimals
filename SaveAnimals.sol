...
// because it elies on the compiler's built in overflow checks.
...
contract SaveAnimals is Context, IERC20, Ownable {
    ...
    string private _name = "SaveAnimals";
    ...
    function _reflectFee(uint256 rFee, uint256 tFee) private {
        ...
        _totalBurn = _totalBurn.add(tFee);
